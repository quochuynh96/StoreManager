...
<body>
	...
	<nav class="navbar-expand-lg navbar navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarText">
			...
			<span class="navbar-text">
				Vai trò đăng nhập : {{ $account->displayname}}
			</span>
		</div>
	</nav>
	...
	<div class="container">
			{{-- Title --}}
			<div class="p-3 mb-2 bg-primary text-white"><center style="font-family: 'Josefin Sans', sans-serif;"><b>THỐNG KÊ HOẠT ĐỘNG CỦA CỬA HÀNG</b></center></div>
			{{-- Content --}}
			<div class="row">
		...
		{{-- Content --}}
				<div class="row">
					<div class="col-md-12 col-sm-12 col-12">
						<div class="p-3 mb-2 bg-success text-white"><center style="font-family: 'Josefin Sans', sans-serif;">DANH MỤC HÓA ĐƠN ĐÃ THANH TOÁN</center></div>
						<table class="table table-striped">
							<thead class="thead-light">
							  <tr>

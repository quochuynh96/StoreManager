	...
	<div class="row">
		<div class="col-md-3 col-sm-12 col-12">
			...
			<ul>
                    ...
                    <li><a class="active" href="{{route('locationManagerGoods')}}">Quản lý hàng trong kho</a></li>
                    <li><a href="{{route('locationHisAddGoods')}}">Lịch sử xuất nhập hàng</a></li>
			</ul>
			</div>
		</div>
		<div class="col-md-9 col-sm-12 col-12">
			<div class="p-3 mb-2 bg-success text-white"><center style="font-family: 'Josefin Sans', sans-serif;">QUẢN LÝ HÀNG TRONG KHO</center></div>
			<div class="row">
				<div class="col-md-12">
				<center>
					<select name="goods" id="goods" style="width: 50%">
						@foreach ($listGoods as $goods)
							<option value="{{$goods->id}}">{{$goods->name}}</option>
						@endforeach
					</select>
					&nbsp;&nbsp;<button id="btnSelectGoods" type="button" class="btn btn-success">Chỉnh sửa thông tin</button>
				</center>
				</div>
			</div>
			<hr>
